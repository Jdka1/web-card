  ...
  return (
    <div className="App">
      ...
      <main className="projects">
        ...
        <Project
          title="Practicum"
          description={"Recently, I recieved a very important piece of advice that I've taken to heart: \"work for your heros\". Recently ive found a startup in SF with great people doing great work. I learn much more this way than starting my own venture, which will be almost guaranteed to fail. 10% you know how to do 0% of that you do right the first try. surround myself with best people pushes me to be better"}
          image="lidar.gif"
