  ...
  return (
    <div className="App">
      ...
      <header className="header">
        <h1>Aryan Mehra</h1>
        <p>Doing and dreaming the unprecedented. <br></br><br></br>
      ...
      <main className="projects">
        ...
        <Project
          ...
          <br></br><br></br>
          Diving deep into transformer CV (computer vision) and NLP (natural language processing) the past 3 years.
          <br></br><br></br>
